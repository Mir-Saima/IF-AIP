...
X_train=np.concatenate((X_train1,X_train2,X_train3,X_train4,X_train5,X_train6,X_train7, X_train8), axis=1, out=None)

X_test01=np.concatenate((X_test1,X_test2,X_test3,X_test4,X_test5,X_test6,X_test7, X_test8), axis=1, out=None)

X_test02=np.concatenate((X_test11,X_test22,X_test33,X_test44,X_test55,X_test66,X_test77, X_test88), axis=1, out=None)
...
for key in model:
    if key=='rfc':
        ...
        print('Results on 1st dataset using ' , key)
        dtc_eval = evaluate_model_test(model[key], X_test01, y_test1)
        print('Results on 2nd dataset using ',key)
